...
const nebulaMat = new THREE.ShaderMaterial({
  ...
  uniforms: {
    uTime: { value: 0 },
    uColB: { value: new THREE.Color(0.02, 0.12, 0.06) },
    uColC: { value: new THREE.Color(0.10, 0.28, 0.13) },
    uColD: { value: new THREE.Color(0.48, 0.80, 0.12) },
    uRainbow: { value: 0 },
  },
  vertexShader: /* glsl */`
    varying vec2 vUv;
...
/* ---------- 配色：色系选择 + 彩虹 ---------- */
const SKY_PALETTES = {
  lavender: [[0.10, 0.08, 0.18], [0.28, 0.20, 0.38], [0.48, 0.42, 0.88]],
