...
export const frameMat = new THREE.MeshBasicMaterial({ color: new THREE.Color(0.72, 1.0, 0.14) });
export const frameHoverMat = new THREE.MeshBasicMaterial({ color: new THREE.Color(0.94, 1.0, 0.74) });
