...
const productEntrances = [
  {
    ...
    en: "AI video machine",
    zh: "AI 影视机器",
    detailEn: "Open the real production tool. Deployed and running.",
    detailZh: "打开真实产品，已部署、正在运行。",
  ...
  },
  {
    ...
    en: "Machine room",
    zh: "机器房间",
    detailEn: "How the machine works inside, plus small tools around it.",
    detailZh: "看机器内部怎么运转，以及围绕它的小工具。",
    href: "/product",
  },
];
